        ...
        <div className="bg-white shadow-lg rounded-lg lg:p-8 pb-12 mb-8">
            ...
            <div className="px-4 lg:px-0">
                ...
                {post.content.raw.children.map((typeObj, index) => {
                    const childrent = typeObj.children.map((item, itemIndex) => getContentFragment(itemIndex, item.text, item))

                    return getContentFragment(index, childrent, typeObj, typeObj.type)
                })}
            </div>
        </div>
    );
